{
	"translatorID": "74df6b63-204a-4383-885b-0084740d5a63",
	"label": "American Antiquarian Society",
	"creator": "Sean Takats (with adaptations by Benjamin Pauley)",
	"target": "catalog.mwa.org",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 250,
	"inRepository": true,
	...
	"lastUpdated": "2021-06-11 16:52:22"
}
	...
	if (m) { //single item
		...
		Zotero.selectItems(items, function (items) {
			...
			Zotero.Utilities.HTTP.doGet(newUris, function (text) {
				...
				marc.setTranslator("3cccaeec-c089-4436-9013-994268a94463");
				marc.setString(text);
